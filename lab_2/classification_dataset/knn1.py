...
train_onehot = cal_onehot(train_text,train_word,row,col)
savetxt("train_onehot",csc_matrix(train_onehot))
...
# my_write('train_onehot',train_onehot)
# savetxt("train_onehot",train_onehot)
# train_onehot = []
# f = open('train_onehot','r')
# line = f.readline()
# while line:
#     # print(line)
#     line = re.split(',| |',line)
#     train_onehot.append(array(line))
#     print(line)
#     line = f.readline()
# for i  in range(4):
#     print(array(train_onehot[i]))

# train_onehot = loadtxt('train_onehot')
